...
function SidebarNav() {
  ...
  const navItems =
    userRole === "freelancer" ? freelancerNavItems : clientNavItems;

  useEffect(() => {
    const updateAccueilScreenData = async () => {
      if (token && user?.id) {
        try {
          const response = await api.get(`/accueilScreen/${user.id}`, {
            headers: {
  ...
  return (
    <View
      style={[
        ...
        {
          backgroundColor:
            userRole === "freelancer" || userRole === "client"
              ? "#FFF"
              : "transparent",
        },
      ]}
          ...
          {userRole === "freelancer" ? (
            <View style={[styles.roleContent, styles.freelancerTheme]}>
              <Text style={styles.roleTitle}>
                {user?.name ? `Welcome back ${user.name},` : "Welcome,"} Super
                Freelancer! 👋
              </Text>
              <Text style={styles.motivationText}>
                Your next great opportunity starts here! Find projects that
                perfectly match your unique skills.
              </Text>
              ...
              <View style={styles.specialFeatureContainer}>
                ...
                <Text style={styles.domainsList}>
                  Web Development • Mobile Apps • AI/ML • Cybersecurity • Cloud
                  Computing • DevOps
                </Text>
            ...
            <View style={[styles.roleContent, styles.clientTheme]}>
              <Text style={styles.roleTitle}>
                {user?.name ? `Welcome back ${user.name},` : "Welcome,"} Valued
                Client! 👋
              </Text>
              <Text style={styles.motivationText}>
              ...
              <View style={styles.specialFeatureContainer}>
                ...
                <Text style={styles.domainsList}>
                  Full-Stack Developers • Mobile Experts • AI Specialists •
                  Cybersecurity Pros • Cloud Architects
                </Text>
